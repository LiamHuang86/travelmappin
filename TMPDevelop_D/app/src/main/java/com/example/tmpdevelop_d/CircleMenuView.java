...
public class CircleMenuView extends FrameLayout {
    ...
    private void initMenu(int menuButtonColor) {
        ...
        // 修改主要 Button 的背景色彩，若不設置則默認為黑色
        //mMenuButton.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.main_color_05)));
    ...
    public void initButtons(@NonNull Context context, @NonNull List<Integer> icons, @NonNull List<Integer> colors) {
        ...
        for (int i = 0; i < buttonsCount; i++) {
            ...
            // 修改外圈 Button 的 Icon 背景色彩，若不設置則默認為黑色
            button.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.main_color_05)));
